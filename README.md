...
| 홈 | AI 분석 결과 | 블로그 리뷰 |
|---|---|---|
| ![홈](docs/screenshots/01-home.png) | ![AI 분석 결과](docs/screenshots/02-ai-analysis.png) | ![블로그 리뷰](docs/screenshots/03-blog-reviews.png) |

| 커뮤니티 | 로그인 | 즐겨찾기 |
|---|---|---|
| ![커뮤니티](docs/screenshots/04-community.png) | ![로그인](docs/screenshots/05-login.png) | ![즐겨찾기](docs/screenshots/06-favorites.png) |

| 다크 모드 (홈) | 다크 모드 (즐겨찾기) |
|---|---|
| ![다크 모드 홈](docs/screenshots/08-home-dark.png) | ![다크 모드 즐겨찾기](docs/screenshots/07-favorites-dark.png) |
...
- Vercel 프로젝트 환경 변수(Production)에 아래 값들이 모두 등록되어 있어야 합니다: `VITE_API_BASE_URL`(배포된 도메인 자신, 예: `https://your-app.vercel.app`), `VITE_SUPABASE_URL`, `VITE_SUPABASE_ANON_KEY`, `NAVER_CLIENT_ID`, `NAVER_CLIENT_SECRET`, `YOUTUBE_API_KEY`
